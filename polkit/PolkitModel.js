...
// PenguID: pam_penguid.so asks "Press Enter for face, or type your password".
function promptOffersFace(text) {
  return String(text || "").toLowerCase().indexOf("enter for face") !== -1
}
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    promptOffersFace: promptOffersFace
  }
}
