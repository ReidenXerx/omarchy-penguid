...
Item {
  ...
  readonly property string faceLookingText: "Looking for you" + String.fromCharCode(0x2026)
  readonly property string passwordRequiredText: "Password required"
  ...
  Rectangle {
    ...
    BorderSurface {
      ...
      Text {
        ...
        text: root.authenticatingPassword ? "Checking…" : (root.failureMessage.length > 0 ? root.failureMessage : (root.faceAuthenticating ? root.faceLookingText : (root.faceBlocked ? root.passwordRequiredText : root.placeholderText)))
